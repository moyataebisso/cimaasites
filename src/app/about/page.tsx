...
export const metadata: Metadata = {
  title: "About — Cimaa Sites",
  description:
    "Cimaa Sites is part of Arsi Technology Group, a Minneapolis-based studio building tools that help local businesses look great online without the headache.",
};
...
const values = [
  ...
  },
  {
    ...
    body: "No template farms. Every Cimaa Site is set up by people who pay attention to your industry, your customers, and your voice.",
  },
  {
  ...
  return (
    <main>
      ...
      <section className="bg-cimaa-bg-tan pt-28 pb-16 md:pt-32 md:pb-20">
        <Container>
          <SectionHeading
            eyebrow="About Cimaa Sites"
            headline="Built by people who get"
            accent="small business"
            subtitle="Cimaa Sites is part of Arsi Technology Group, a Minneapolis-based studio building tools that help local businesses look great online without the headache."
          />
        </Container>
      </section>
        ...
        <Container>
          <div className="max-w-6xl mx-auto grid lg:grid-cols-[1fr_2fr] gap-10 lg:gap-16">
            ...
            <div className="space-y-5 text-lg text-cimaa-text-muted leading-relaxed">
              <p>
                Most website platforms are built for developers. Cimaa Sites is
                built for the salon owner, the restaurant manager, the trucking
                company that needs a website but doesn&apos;t have time to
                figure out hosting, plugins, and SEO.
              </p>
              <p>
                We built Cimaa Sites because we kept watching small businesses
                pay agencies thousands for sites they couldn&apos;t update, on
                platforms they didn&apos;t understand. There had to be a better
                way.
              </p>
              <p>
        ...
        <Container>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {values.map((v) => (
              ...
              >
                <h3 className="text-xl font-bold text-cimaa-text">{v.title}</h3>
        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-cimaa-text-muted leading-relaxed">
              Beyond Cimaa Sites, Arsi Technology Group builds platforms for
